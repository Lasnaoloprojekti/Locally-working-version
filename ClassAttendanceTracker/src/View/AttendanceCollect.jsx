        ...
        <>        <nav className="flex justify-between items-center">
            ...
            <section className=" flex-row h-[80vh] mt-8 flex ">
                <div className=" w-1/2 flex items-center flex-col">
                    ...
                    <h1 className=" font-roboto-slab text-xl mb-4 font-semibold tracking-wider">{decodeURIComponent(topic)}</h1>
                    ...
                    <button className=" py-2 px-6 bg-orange-600 rounded-md text-white font-roboto-slab mt-5 hover:bg-red-800 " onClick={handleCloseSession}>Deactive collecting attendances</button>
                ...
                <div className=" w-1/2 h-[80vh]  flex flex-col">
                    <div className="flex gap-4 justify-center text-2xl font-bold ">
                        ...
                        <span className=" font-roboto-slab">{attendingStudents.length}</span>
                    </div>
                    <li className="flex justify-center font-open-sans">
                        <ul className="flex flex-col gap-1 my-2">
                            {attendingStudents.map((student, index) => (
                                <p className=" " key={index}>{student.firstName} {student.lastName}</p>
                            ))}
                            {sessionClosed && (
                                <Link to="/teacherhome" className=" text-blue-500 text-lg underline hover:text-green-800">
