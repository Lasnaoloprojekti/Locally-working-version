...
export const Registration = () => {
    ...
    return (<>
        <nav className="flex justify-between items-center">
            <div className='ml-3 text-2xl flex font-thin flex-row gap-5'>
        ...
        <form className='flex flex-row h-[100vh] justify-center ' action="handleSubmit">
            <div className='w-96 h-min mt-32 text-black p-2   '>
                <label className="block text-black text-sm  font-semibold mb-2">Class registration</label>
                <input className='text-center p-5 rounded-md border-stone-900 w-full border text-orange-600'
                    type="text"
