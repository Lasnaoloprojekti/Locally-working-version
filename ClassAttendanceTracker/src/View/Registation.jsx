...
export const Registration = () => {
    ...
    const handleRegistration = async (event) => {
        ...
        try {
            ...
            setRegisterMessage('This student number is either not in the course or you may have already enrolled. Ask help from your teacher.');
        }
    };
    ...
    return (<>
        ...
        <section className='flex flex-col w-100  items-center'>
            <form className='flex flex-col h-[100vh] w-1/2 ' onSubmit={handleRegistration}>
                <div className='  h-min mt-32 flex flex-col justify-center text-black p-2   '>
                    ...
                    <button className=" bg-orange-600 p-1 rounded-md text-white font-roboto-slab mt-3 hover:bg-red-800 ">Enroll</button>
                ...
                <p className={`self-center w-2/3 mt-6 underline ${registerMessage.includes('successful') ? 'text-green-600' : 'text-red-600'}`}>
                    {registerMessage}
                </p>
            </form>
